...
<div align="center">
  A simple Meeting Calendar app made with PHP that uses a database.
</div>

<br />

![](https://visit-counter.vercel.app/counter.png?page=Alcoreza/AD-Meeting-Calendar)
...
A simple Meeting Calendar app made with PHP that uses a database like MongoDB or PostgreSQL.
...
| Title   | Purpose                                                | Link                 |
| ------- | ------------------------------------------------------ | -------------------- |
| ChatGPT | Utilized for solving the different errors encountered. | https://chatgpt.com/ |
